...
** EdgeLB must be built and installed from the https://github.com/mesosphere/dcos-edge-lb/tree/master[`master`] branch.
   A stub-universe is available, see https://docs.google.com/document/d/12vcs86LVVyYFZIEPIkOd9cNu45qNojXV1Zoi4aCuINA/edit#heading=h.43gebytc8427[here] for details.
