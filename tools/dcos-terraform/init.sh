...
# - DCOS_VERSION (default: 1.13.3)
DCOS_VERSION=${DCOS_VERSION:-1.13.3}
...
# - DCOS_BOOTSTRAP_MACHINE_TYPE (default: n1-standard-4)
DCOS_BOOTSTRAP_MACHINE_TYPE=${DCOS_BOOTSTRAP_MACHINE_TYPE:-n1-standard-4}
