...
// DummyIngressResource returns a dummy, minimal Service resource with the specified namespace and name.
...
// WithAnnotations returns a customizer that sets the specified ports on a Service resource.
